...
namespace ESO.Models
{
    public static class Extensions
    {
        ...
        public static ESOLink GetLinkFromRelatedLink(this UmbracoHelper umbraco, Umbraco.Web.Models.Link link)
        {
            var link2 = new ESOLink();
        ...
        public static ESOLink GetLinkFromRelatedLinks(this UmbracoHelper umbraco, IEnumerable<Umbraco.Web.Models.Link> links)
        {
            var link = new ESOLink();
            // TODO Fix
            return link;
            // TODO Fix
